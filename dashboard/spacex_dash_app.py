...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        temp_df = spacex_df[spacex_df['Launch Site'] == entered_site]['class'].value_counts().to_frame()
        temp_df['name'] = ['Failure', 'Success']
        fig = px.pie(new_df, values='class', names='name', title='Successful launches in ' + entered_site)
...
def plot_scatter(input1, input2):
    if input1 == 'ALL':
        new_df = spacex_df
    else:
